    ...
    <>
      <div className="w-[70%] mt-20 mx-auto h-[400px] rounded-md absolute left-[15%] z-20 right-[25%] pt-10">
        <div className="lg:text-7xl md:text-5xl sm:text-3xl font-semibold text-zinc-100 flex flex-col justify-center items-center">
          <h1>Welcome to </h1>
          <span className='bg-gradient-to-r from-pink-300 via-fuchsia-300 to-indigo-100 inline-block text-transparent bg-clip-text' >Notewave</span>
        </div>
        ...
        <div className="flex flex-wrap justify-between list-none sm:w-[50%] lg:w-[30%] md:w-[50%] mx-auto mt-10">
          <li className='py-1 lg:px-6 md:px-3 sm:px-2  bg-blue-50  hover:bg-blue-100  text-[#0D111D] rounded-sm font-medium '><NavLink to='/login'>Login</NavLink></li>
          <li className='py-1 lg:px-6 md:px-3 sm:px-2 border-2 border-blue-50 text-zinc-100 hover:text-[#010219] hover:bg-opacity-100 hover:bg-blue-50 rounded-sm font-medium '><NavLink to='/signup'>Sign Up</NavLink></li>
        </div>
      </div>
