                    ...
                    <div className="w-[70%] text-white mx-auto">
                        ...
                        <div className="border border-[#C6C5FF] border-opacity-50 rounded-md mt-10">
                            ...
                            <div className="mt-1 px-2">
                                <h2 className="text-opacity-50 text-[#E9E9E9]">Title</h2>
                                <input
                                    required
                                    name='title'
                                    type="text"
                            ...
                            <div className="mt-1 px-2">
                                <h2 className="text-opacity-50 text-[#E9E9E9]">Description</h2>
                                <textarea
                                    name="content"
                            ...
                            <div className="mt-1 px-2">
                                <h2 className="text-opacity-50 text-[#E9E9E9]">Category</h2>
                                <input
                                    type="text"
                                    name='category'
                                    className='w-full rounded-sm bg-[#010219] py-1 outline-none border border-[#C6C5FF] border-opacity-50 text-[#E9E9E9] px-2'
                            ...
                            <div className="mt-1 px-2">
                                <h2 className="text-opacity-50 text-[#E9E9E9]">Upload Images</h2>
                                <input
                                    type="file"
                                    name="images"
                                    multiple
                                    accept="image/*"
                                    className='w-full bg-[#010219] py-1 outline-none border border-[#C6C5FF] border-opacity-50 text-[#E9E9E9] px-2'
                                    onChange={handleChange}
                                />
                            </div>
                            <div className="mt-1 px-2">
                                <h2 className="text-opacity-50 text-[#E9E9E9]">Upload PDFs</h2>
                                <input
                                    type="file"
                                    name="pdfs"
                                    multiple
